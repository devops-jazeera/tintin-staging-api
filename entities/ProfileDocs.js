...
var ProfileDocs = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.Column)({ name: "doc_number" }),
        __metadata("design:type", String)
    ], ProfileDocs.prototype, "doc_number", void 0);
    __decorate([
        (0, typeorm_1.Column)({ name: "exp_date" }),
    ...
    __decorate([
        ...
        (0, typeorm_1.ManyToOne)(function (type) { return Profile_1.Profile; }),
        __metadata("design:type", Profile_1.Profile)
    ], ProfileDocs.prototype, "profile", void 0);
    __decorate([
        (0, typeorm_1.JoinColumn)({ name: "doc_file_id" }),
        (0, typeorm_1.ManyToOne)(function (type) { return FileData_1.FileData; }),
    ...
    __decorate([
        (0, typeorm_1.JoinColumn)({ name: "img_file_id" }),
        (0, typeorm_1.ManyToOne)(function (type) { return FileData_1.FileData; }),
        __metadata("design:type", FileData_1.FileData)
    ], ProfileDocs.prototype, "imgFile", void 0);
    __decorate([
        (0, typeorm_1.JoinColumn)({ name: "branch_id" }),
        (0, typeorm_1.ManyToOne)(function (type) { return Branch_1.Branch; }),
        __metadata("design:type", Branch_1.Branch)
    ], ProfileDocs.prototype, "branch", void 0);
    ProfileDocs = __decorate([
        (0, typeorm_1.Entity)("profile_docs")
    ], ProfileDocs);
    return ProfileDocs;
}());
