...
var DatabaseMaster = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.Column)({ name: "shot" }),
        __metadata("design:type", String)
    ], DatabaseMaster.prototype, "shot", void 0);
    __decorate([
        (0, typeorm_1.Column)({ name: "shot_conversion" }),
    ...
    __decorate([
        ...
        (0, typeorm_1.ManyToOne)(function (type) { return PigmentSet_1.PigmentSet; }, function (pigmentSet) { return pigmentSet.id; }),
        __metadata("design:type", PigmentSet_1.PigmentSet)
    ], DatabaseMaster.prototype, "pigmentSet", void 0);
    __decorate([
        (0, typeorm_1.Column)({ name: "coating_type" }),
        __metadata("design:type", String)
    ], DatabaseMaster.prototype, "coating_type", void 0);
    DatabaseMaster = __decorate([
        (0, typeorm_1.Entity)("database_master")
    ], DatabaseMaster);
