...
var DataAreas = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.Column)({ name: "route_en" }),
        __metadata("design:type", String)
    ], DataAreas.prototype, "route_en", void 0);
    __decorate([
        (0, typeorm_1.Column)({ name: "route_ar" }),
        __metadata("design:type", String)
    ], DataAreas.prototype, "route_ar", void 0);
    __decorate([
        (0, typeorm_1.Column)({ name: "currency_en" }),
        __metadata("design:type", String)
    ], DataAreas.prototype, "currency_en", void 0);
    __decorate([
        (0, typeorm_1.Column)({ name: "currency_ar" }),
        __metadata("design:type", String)
