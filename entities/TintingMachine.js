...
var TintingMachine = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.Column)({ name: "mfg_date" }),
        __metadata("design:type", Date)
    ], TintingMachine.prototype, "mfg_date", void 0);
    __decorate([
        (0, typeorm_1.Column)({ name: "installation_date" }),
        __metadata("design:type", Date)
    ...
    __decorate([
        (0, typeorm_1.Column)({ name: "license_key" }),
        __metadata("design:type", String)
    ], TintingMachine.prototype, "license_key", void 0);
    __decorate([
        (0, typeorm_1.Column)({ name: "service_occurance" }),
    ...
    __decorate([
        (0, typeorm_1.Column)({ name: "dealerid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        ...
        (0, typeorm_1.ManyToOne)(function (type) { return Dealer_1.Dealer; }),
        __metadata("design:type", Dealer_1.Dealer)
    ], TintingMachine.prototype, "dealer", void 0);
    __decorate([
        (0, typeorm_1.JoinColumn)({ name: "system_code" }),
        (0, typeorm_1.ManyToOne)(function (type) { return DatabaseMaster_1.DatabaseMaster; }),
    ...
    __decorate([
        ...
        (0, typeorm_1.ManyToOne)(function (type) { return Technician_1.Technician; }),
    ...
    __decorate([
        ...
        (0, typeorm_1.ManyToOne)(function (type) { return Address_1.Address; }, { cascade: true }),
    ...
    __decorate([
        ...
        (0, typeorm_1.OneToOne)(function (type) { return CountryMaster_1.CountryMaster; }, function (cou) { return cou.id; }),
        __metadata("design:type", CountryMaster_1.CountryMaster)
    ], TintingMachine.prototype, "countryMaster", void 0);
    __decorate([
        (0, typeorm_1.JoinColumn)({ name: "country_id" }),
        (0, typeorm_1.ManyToOne)(function (type) { return AreaMaster_1.AreaMaster; }, function (area) { return area.country_id; }),
    ...
    __decorate([
        (0, typeorm_1.Column)({ name: "machine_photo_id" }),
        __metadata("design:type", String)
    ], TintingMachine.prototype, "machine_photo_id", void 0);
    __decorate([
        (0, typeorm_1.Column)({ name: "machine_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, typeorm_1.Column)({ name: "client_updated_on" }),
        __metadata("design:type", Date)
    ...
    TintingMachine = __decorate([
        (0, typeorm_1.Entity)("tinting_machine")
    ], TintingMachine);
