...
var ProductMaster = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_2.OneToMany)(function (type) { return BasesMaster_1.BasesMaster; }, function (base) { return base.product; }),
        __metadata("design:type", Array)
    ], ProductMaster.prototype, "bases", void 0);
    __decorate([
        (0, typeorm_1.JoinColumn)({ name: "system_code", referencedColumnName: "system_code" }),
        (0, typeorm_1.OneToOne)(function (type) { return DatabaseMaster_1.DatabaseMaster; }, function (db) { return db.system_code; }),
