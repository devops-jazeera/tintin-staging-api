...
var BasesMaster = /** @class */ (function () {
    ...
    __decorate([
        ...
        (0, typeorm_1.ManyToOne)(function (type) { return ProductMaster_1.ProductMaster; }, function (product) { return product.id; }),
        __metadata("design:type", ProductMaster_1.ProductMaster)
    ], BasesMaster.prototype, "product", void 0);
    __decorate([
        (0, typeorm_1.OneToMany)(function (type) { return BaseSizes_1.BaseSizes; }, function (base) { return base.base; }),
        __metadata("design:type", Array)
    ], BasesMaster.prototype, "baseSizes", void 0);
    __decorate([
        (0, typeorm_1.OneToMany)(function (type) { return BaseSizeColors_1.BaseSizeColors; }, function (base) { return base.base; }),
        __metadata("design:type", Array)
    ], BasesMaster.prototype, "baseSizePrices", void 0);
    BasesMaster = __decorate([
        (0, typeorm_1.Entity)("bases")
    ], BasesMaster);
    return BasesMaster;
}());
