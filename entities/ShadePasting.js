...
var ShadePasting = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.Column)({ name: "colorant" }),
        __metadata("design:type", String)
    ], ShadePasting.prototype, "colorant", void 0);
    __decorate([
        (0, typeorm_1.Column)({ name: "shots" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, typeorm_1.Column)({ name: "deleted_on" }),
        __metadata("design:type", Date)
    ], ShadePasting.prototype, "deleted_on", void 0);
    __decorate([
        (0, typeorm_1.Column)({ name: "deleted_by" }),
        __metadata("design:type", String)
    ...
    __decorate([
        ...
        (0, typeorm_1.ManyToOne)(function (type) { return ProductMaster_1.ProductMaster; }),
    ...
    __decorate([
        ...
        (0, typeorm_1.ManyToOne)(function (type) { return BasesMaster_1.BasesMaster; }),
    ...
    __decorate([
        ...
        (0, typeorm_1.ManyToOne)(function (type) { return PigmentSet_1.PigmentSet; }, function (ps) { return ps.id; }),
        __metadata("design:type", PigmentSet_1.PigmentSet)
    ], ShadePasting.prototype, "pigmentSet", void 0);
    ShadePasting = __decorate([
        (0, typeorm_1.Entity)("shade_pasting")
    ], ShadePasting);
    return ShadePasting;
}());
