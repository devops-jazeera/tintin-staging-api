...
var ColorMasterDAO = /** @class */ (function () {
    function ColorMasterDAO() {
        this.dao = (0, typeorm_1.getRepository)(ColorMaster_1.ColorMaster);
        this.daoCopy = (0, typeorm_1.getRepository)(ColorMasterCopy_1.ColorMasterCopy);
        this.catalogue = (0, typeorm_1.getRepository)(CatalogueMaster_1.CatalogueMaster);
