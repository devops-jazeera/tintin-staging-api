...
exports.ProductAttributeDAO = void 0;
...
var ProductAttributeDAO = /** @class */ (function () {
    function ProductAttributeDAO() {
        this.dao = (0, typeorm_1.getRepository)(ProductAttribute_1.ProductAttribute);
    ...
    ProductAttributeDAO.prototype.search = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dao.createQueryBuilder("productAttributes").where(data).orderBy("productAttributes.id", "ASC").getMany()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    ProductAttributeDAO.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ProductAttributeDAO.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ProductAttributeDAO.prototype.delete = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ProductAttributeDAO.prototype.findOne = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.ProductAttributeDAO = ProductAttributeDAO;
