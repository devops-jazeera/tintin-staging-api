...
exports.BasesMastersDAO = void 0;
...
var BasesMastersDAO = /** @class */ (function () {
    function BasesMastersDAO() {
        this.dao = (0, typeorm_1.getRepository)(BasesMaster_1.BasesMaster);
        this.productdao = (0, typeorm_1.getRepository)(ProductMaster_1.ProductMaster);
    ...
    BasesMastersDAO.prototype.search = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dao.createQueryBuilder("bases").where(data).orderBy("bases.id", "ASC").getMany()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    BasesMastersDAO.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    BasesMastersDAO.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    BasesMastersDAO.prototype.delete = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    BasesMastersDAO.prototype.findOne = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return BasesMastersDAO;
}());
exports.BasesMastersDAO = BasesMastersDAO;
Object.seal(BasesMastersDAO);
