...
var DispenseLogDAO = /** @class */ (function () {
    function DispenseLogDAO() {
        this.dao = (0, typeorm_1.getRepository)(DispenseLog_1.DispenseLog);
        ...
        this.color = (0, typeorm_1.getRepository)(ColorMaster_1.ColorMaster);
