...
exports.StoresDAO = void 0;
var typeorm_1 = require("typeorm");
var Address_1 = require("../../entities/Address");
var Stores_1 = require("../../entities/Stores");
var StoresDAO = /** @class */ (function () {
    function StoresDAO() {
        this.dao = (0, typeorm_1.getRepository)(Stores_1.Stores);
        this.addressDao = (0, typeorm_1.getRepository)(Address_1.Address);
    }
    StoresDAO.prototype.search = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dao.createQueryBuilder("stores").where(data).orderBy("stores.id", "ASC").getMany()];
    ...
    StoresDAO.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    StoresDAO.prototype.delete = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    StoresDAO.prototype.findOne = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.StoresDAO = StoresDAO;
Object.seal(StoresDAO);
