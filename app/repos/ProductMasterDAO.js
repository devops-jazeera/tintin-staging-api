...
var ProductMasterDAO = /** @class */ (function () {
    ...
    ProductMasterDAO.prototype.search = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.dao.createQueryBuilder("products").where(data).orderBy("products.id", "ASC").getMany()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    ProductMasterDAO.prototype.save = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        _a.label = 5;
                    case 5:
                        if (!(data.dataBaseMaster && data.dataBaseMaster.id)) return [3 /*break*/, 7];
                        return [4 /*yield*/, queryRunner.manager.getRepository(DatabaseMaster_1.DatabaseMaster).save(data.dataBaseMaster)];
                    case 6:
                        _a.sent();
                        _a.label = 7;
                    case 7: return [4 /*yield*/, queryRunner.manager.getRepository(ProductMaster_1.ProductMaster).save(data)];
                    case 8:
                        _a.sent();
    ...
    ProductMasterDAO.prototype.entity = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ProductMasterDAO.prototype.delete = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ProductMasterDAO.prototype.findOne = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.ProductMasterDAO = ProductMasterDAO;
Object.seal(ProductMasterDAO);
