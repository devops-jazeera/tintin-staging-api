...
exports.ProductMasterDAO = void 0;
...
var ProductMasterDAO = /** @class */ (function () {
    function ProductMasterDAO() {
        this.dao = (0, typeorm_1.getRepository)(ProductMaster_1.ProductMaster);
        this.vendor = (0, typeorm_1.getRepository)(Vendor_1.Vendor);
        this.dataBaseMaster = (0, typeorm_1.getRepository)(DatabaseMaster_1.DatabaseMaster);
    }
