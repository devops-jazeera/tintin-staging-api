...
var TechnicianDAO = /** @class */ (function () {
    function TechnicianDAO() {
        this.dao = (0, typeorm_1.getRepository)(Technician_1.Technician);
        this.address = (0, typeorm_1.getRepository)(Address_1.Address);
        this.countryMaster = (0, typeorm_1.getRepository)(AccessData_1.AccessData);
