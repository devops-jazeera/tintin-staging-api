...
function en(n) {
    var string = n.toString(), units, tens, scales, and = " and ";
    ...
    var decimalFind = string.split(".");
    console.log(decimalFind);
...
exports.en = en;
function ar(n) {
    var string = n.toString(), units, tens, scales, and = " و ";
    /* Remove spaces and commas */
    string = string.replace(/[, ]/g, "");
    /* Is number zero? */
    if (parseInt(string) === 0) {
    ...
    /* Array of tens as words */
    tens = ["", "", "عشرون", "ثلاثون", "أربعين", "خمسون", "ستون", "سبعون", "ثمانون", "تسعين"];
    /* Array of scales as words */
    scales = [
        "",
        "ألف",
